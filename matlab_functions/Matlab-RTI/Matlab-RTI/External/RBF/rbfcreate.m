...
if (nargin == 0) & (nargout == 0)
  ...
  fprintf('     RBFFunction: [ gaussian  | thinplate | cubic | multiquadric | {linear} ]\n');
...
function u=rbfphi_test(r, const)
u=sqrt(2 + r.*r /(const*const));
end