...
eng.addpath("C:\\Users\\Ramamoorthy_Luxman\\OneDrive - Université de Bourgogne\\imvia\\work\\nblp\\SurfaceAdaptiveRTI\\matlab_functions\\pkg_PTM")
...
print("############")
ptm_coeffs = eng.get_ptm_coeffs(lps, matlab_img_mat)

relighted_img = eng.get_ptm_interpolated_img(lps[45], ptm_coeffs, h, w)
#
# test_dir = lps[2]
