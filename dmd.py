...
eng.addpath("C:\\Users\\Ramamoorthy_Luxman\\OneDrive - Université de Bourgogne\\imvia\\work\\codes\\matlab\\yuly\\")
...
print("############")
dmd_coeffs = eng.py_interface(matlab_img_mat, lps)
print("???????")